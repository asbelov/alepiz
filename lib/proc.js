    ...
    if(module.parent) { // parent
        ...
        child.on('message', function(message) {
            if (message.childMessageCnt) {
                ...
                console.log('Max message size sending from parent to child: ', parentMessageSize, '; messageCnt sending: ', parentMessageCnt, '; messageCnt recv by child: ', _parentMessageCnt);
                console.log('Max message size sending from child to parent: ', childMessageSize, '; messageCnt sending: ', childMessageCnt, '; messageCnt recv by parent: ', _childMessageCnt);
