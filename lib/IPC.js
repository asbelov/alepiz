...
IPC.server = function(cfg, callback) {
    ...
    const log = require('../serverLog/simpleLog')(id || 'Server');
 ...
 *  was not initialised.
 * @property {[function()]} stop run onStop() function if exist, than run disconnect() method
 * @property {[function()]} disconnect disconnect from the IPC.server
 * @property {[function()]} destroy alias to the disconnect method
...
IPC.client = function(cfg, callback) {
    ...
    const log = require('../serverLog/simpleLog')(id || 'Client');
    ...
    function connect(connectCallback) {
        ...
        if(reconnectAttempts) {
            log.warn('Reconnect to ' + hostPort +
