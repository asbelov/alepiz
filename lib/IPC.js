...
IPC.server = function(cfg, callback) {
    ...
    function stop(callback) {
        ...
        // Stops the server from accepting new connections and keeps existing connections. The optional callback will be called once the 'close' event occurs
...
function cleanUpCallbackStack(callbackStack, keepCallbackInterval) {
    ...
    for(var [id, callbackObj] of callbackStack.entries()) {
        if(callbackObj.timestamp  + keepCallbackInterval < now) callbackStack.delete(id);
    }
