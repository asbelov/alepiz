...
function replaceVariables(exprStr, variables, quotedStrings, callback) {
    ...
    // remove identical variables so as not to evaluate them multiple times
    quotedStrings = quotedStrings.filter((element, index) => { return quotedStrings.indexOf(element) === index });
