 ...
 * @param {{module: NodeModule}} options - options {moduleName: <moduleName>, {<function>: permanentCallback: <true|false>}}
 * @param {function(Error)|function(null, object)} callback - callback(err, obj) - return error or obj like
 * @param {string} options.moduleName the label used in the log file
 * @param {NodeModule} options.module node.js module object for send module.sessionID to the thread
 * @param {Object} options.function <function> — the name of the exported function to apply the
