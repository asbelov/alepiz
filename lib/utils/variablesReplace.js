 ...
 *      allUnresolvedVariables: Array<string>
 * }} - return undefined if type of the first parameter is not a "string" or first parameter is empty string.
...
function variablesReplace(str, variables) {
    ...
    for(var result = re.exec(str), firstAttempt = true, unresolvedVariables = [], allUnresolvedVariables = [];
        result !== null; result = re.exec(str)) {
        /*
