...
/**
 * Generate XOF shake256 7 bytes hash from string, number or object.
 * f.e. for "revenge" will generate 71080704954945890
 * @param {Object|String|Number} init - source for make hash
 *  for alternate streams of the same init
 * @returns {number} - XOF shake256 7 bytes hash
 */
