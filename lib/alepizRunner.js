...
var dbServer = require('../serverDB/dbServerRunner');
var initDB = require('../models_db/createDB/createAllDB');
var history = require('../models_history/history');
var server = require('../server/serverRunner');
var webServer = require('../serverWeb/webServerRunner');
...
var dynamicLog = require('../serverDebug/debugCountersRunner');
...
function onStop(callback) {
    setTimeout(onDestroy, stopTimeout, callback).unref();
...
function restart() {
    if(history.cacheServiceIsRunning()){
        ...
        return setTimeout(restart, 15000).unref();
    }
