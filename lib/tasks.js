...
var dataFile = path.join(__dirname, '..', (conf.get('taskServer:dataPath') || 'db'), (conf.get('taskServer:dataFile') || 'taskConditions.json'));
...
tasks.startCheckConditions = function(callback) {
    history.connect(function (err) {
        ...
        }, Number(conf.get('taskServer:waitingConditionsTime')) || 30000);
...
function replaceVariablesToValues(name, value, variables, callback) {
    ...
    var res = calc.variablesReplace(value, variables);
